...
public final class MockPasswordTextBox extends MockWrapper {
	...
	public MockPasswordTextBox(SimpleEditor editor) {
		...
		// Change PasswordTextBox text so that it doesn't show up as a blank box
		// in the designer.
	 ...
	 *
	 * <p/>
	 * The purpose of this class is to create a clone of the PasswordTextBox
	 * passed to the constructor. It will be used to determine the preferred
	 * size of the PasswordTextBox, without having the size constrained by its
	 * parent, since the cloned PasswordTextBox won't have a parent.
	 */
	...
	public void onPropertyChange(String propertyName, String newValue) {
		...
		if (propertyName.equals(PROPERTY_NAME_TEXTALIGNMENT)) {
			setTextAlignmentProperty(newValue);
				...
				|| propertyName.equals(PROPERTY_NAME_BACKGROUNDCOLOR_GRADIENT)) {
			...
			setHintProperty(newValue);
				...
				|| propertyName.equals(PROPERTY_NAME_TEXTCOLOR_GRADIENT)) {
